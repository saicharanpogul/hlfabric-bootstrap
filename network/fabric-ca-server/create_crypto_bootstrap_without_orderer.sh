...
generateCrypto() {
  ...
  # mkdir -p ../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com

  # echo
  # echo "Generate the Orderer0 MSP"
  # echo

  # fabric-ca-client enroll -u https://orderer0:orderer0pw@localhost:$CA_PORT --caname ca.$ORG_NAME.$DOMAIN_NAME.com -M ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/msp --csr.hosts $ORG_NAME.$DOMAIN_NAME.com --csr.hosts localhost --tls.certfiles ${PWD}/../organizations/fabric-ca/$ORG_NAME/tls-cert.pem

  # cp ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/msp/config.yaml ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/msp/config.yaml

  # echo
  # echo "Generate the orderer0 TLS-Certs"
  # echo

  # fabric-ca-client enroll -u https://orderer0:orderer0pw@localhost:$CA_PORT --caname ca.$ORG_NAME.$DOMAIN_NAME.com -M ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls --enrollment.profile tls --csr.hosts $ORG_NAME.$DOMAIN_NAME.com --csr.hosts localhost --tls.certfiles ${PWD}/../organizations/fabric-ca/$ORG_NAME/tls-cert.pem

  # cp ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls/tlscacerts/* ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls/ca.crt

  # cp ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls/signcerts/* ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls/server.crt

  # cp ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls/keystore/* ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls/server.key

  # mkdir ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/msp/tlscacerts

  # cp ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls/tlscacerts/* ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/msp/tlscacerts/tlsca.$ORG_NAME.$DOMAIN_NAME.com-cert.pem

  # #mkdir ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/msp/tlscacerts

  # cp ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/orderers/$ORG_NAME.$DOMAIN_NAME.com/tls/tlscacerts/* ${PWD}/../organizations/peerOrganizations/$ORG_NAME.$DOMAIN_NAME.com/msp/tlscacerts/tlsca.$ORG_NAME.$DOMAIN_NAME.com-cert.pem
